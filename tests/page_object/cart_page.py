...
def check_item_in_cart(driver_instance):
    elem = wait_for_visibility_of_element_xpatch(driver_instance, item_in_cart)
    return elem.is_displayed()


def remove_item_from_cart(driver_instance):
    driver_instance.find_element(By.XPATH, remove_item_from_cart_button).click()
...
def approve_cart(driver_instance):
    driver_instance.find_element(By.XPATH, submit_cart).click()
